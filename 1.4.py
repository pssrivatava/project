...
image1=cv2.imread('G:pics\Image3.jpg')
def aruco_detect():
    ...
    cnt1=contours[0]
    MC1=cv2.moments(cnt1)
    cx1=int(MC1['m10']/MC1['m00'])
    cy1=int(MC1['m01']/MC1['m00'])
    ...
    cnt2=contours[3]
    MC2=cv2.moments(cnt2)
    cx2=int(MC2['m10']/MC2['m00'])
    cy2=int(MC2['m01']/MC2['m00'])
    ...
    im2 = cv2.drawContours(image1, contours, 5, (0,255,0), 25)
    cv2.circle(image1, (cx1, cy1), 3, (0, 0, 0), -1)
    cv2.putText(image1,c1+c9+c2, (cx1-40,cy1+30),cv2.FONT_HERSHEY_SIMPLEX, 0.6, (0, 0, 0), 2)
    
    im2 = cv2.drawContours(image1, contours, 3, (255,0,0), 25)
    cv2.circle(image1, (cx2, cy2), 3, (0, 0, 0), -1)
